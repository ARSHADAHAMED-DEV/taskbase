...
const ICONS = {
  ...
  runbooks: "M8 4H7a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1 M9 4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2H9z M8 12l2 2 4-4 M13 15h4",
  commands: "M4 5h16v14H4z M8 9l3 3-3 3 M13 15h4",
  roadmap: "M3 6l6-2 6 2 6-2v14l-6 2-6-2-6 2z M9 4v14 M15 6v14",
  bugs: "M8 7a4 4 0 0 1 8 0 M6 11h12v3a6 6 0 0 1-12 0z M3 13h3 M18 13h3 M4 8l2 2 M20 8l-2 2 M12 20v1",
  changelog: "M12 8v5l3 2 M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0",
  resources: "M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1 M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1",
  ...
  sun: "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z M12 3v2 M12 19v2 M5 5l1 1 M18 18l1 1 M3 12h2 M19 12h2 M5 19l1-1 M18 6l1-1",
...
export default function Icon({ name, className = "h-5 w-5" }: IconProps) {
  ...
  const paths = pathData.split(" M").map((seg, i) =>
    i === 0 ? seg : `M${seg}`
  );
